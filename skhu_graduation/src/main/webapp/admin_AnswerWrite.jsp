							...
							<div class="table-responsive">
								<table class="table table-bordered" style="font-size: 17px;">
									...
									<tr>
										...
										<td>
											<textarea id="bootstrap-editor" style="width: 100%; height: 200px;" name="reply"></textarea>
										</td>
									</tr>
								</table>
								<div class="form-group" style="margin-top: 30px; margin-left: 150px;">
									<input type="submit" value="답변달기" class="btn btn-outline-primary" style="margin-right: 50px;">
